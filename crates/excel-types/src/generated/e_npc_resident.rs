...
impl Sheet for ENpcResident {
    const SHEET_NAME: &'static str = "ENpcResident";
}

impl FromExcelRow for ENpcResident {
    fn from_row(row: &ExcelRow) -> Option<Self> {
        ...
        Some(Self {
            ...
            title: single_row.columns.get(8).to_owned_string(),
            map: single_row.columns.get(9).to_u8(),
        })
    }
}
