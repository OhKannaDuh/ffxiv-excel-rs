...
pub struct GCRankGridaniaFemaleText {
    ...
    pub pronoun: i8,
    pub article: i8,
    pub name_rank: String,
}

impl Sheet for GCRankGridaniaFemaleText {
    const SHEET_NAME: &'static str = "GCRankGridaniaFemaleText";
}

impl FromExcelRow for GCRankGridaniaFemaleText {
    fn from_row(row: &ExcelRow) -> Option<Self> {
        ...
        Some(Self {
            ...
            name_rank: single_row.columns.get(8).to_owned_string(),
        })
    }
}
