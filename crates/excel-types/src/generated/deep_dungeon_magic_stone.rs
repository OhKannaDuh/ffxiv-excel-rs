...
impl Sheet for DeepDungeonMagicStone {
    const SHEET_NAME: &'static str = "DeepDungeonMagicStone";
}

impl FromExcelRow for DeepDungeonMagicStone {
    fn from_row(row: &ExcelRow) -> Option<Self> {
        ...
        Some(Self {
            ...
            tooltip: single_row.columns.get(10).to_owned_string(),
        })
    }
}
